...
CREATE TABLE IF NOT EXISTS `PlanManager`.`Materias` (
  ...
  `Estado` ENUM("Pendiente", "Cursando", "Regular", "Aprobado", "Aprobado con promocion") NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PlanManager`.`Correlativas` (
  ...
  UNIQUE INDEX `Alternative_Key` (`Materias_Id_Bloqueada` ASC, `Materias_Id_Correlativa` ASC) VISIBLE,
